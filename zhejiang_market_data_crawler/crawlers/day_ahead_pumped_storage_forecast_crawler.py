...
class DayAheadPumpedStorageForecastCrawler(JSONCrawler):
    """日抽蓄总出力预测爬虫"""
    ...
    def __init__(self, target_table=None, cookie=None):
        ...
        Args:
            ...
            cookie: API请求的Cookie
        """
        super().__init__('day_ahead_pumped_storage_forecast')
        ...
        self.field_name = "day_ahead_pumped_storage_forecast"  # 抽蓄总出力预测(日)(MW)
...
async def crawl_day_ahead_pumped_storage_forecast_for_date(date_str, target_table=None, cookie=None):
    """
    获取指定日期的日抽蓄总出力预测数据
    ...
    """
    crawler = DayAheadPumpedStorageForecastCrawler(target_table=target_table, cookie=cookie)
