...
async def crawl_non_market_nuclear_forecast_for_date(date_str, target_table=None, cookie=None):
    crawler = NonMarketNuclearForecastCrawler(target_table=target_table, cookie=cookie)
