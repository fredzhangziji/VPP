...
FIELD_NAME = 'week_ahead_pumped_storage_forecast'

# 设置日志记录器
logger = setup_logger('test_week_ahead_pumped_storage_forecast')
...
async def test_single_date():
    ...
    try:
        crawler = WeekAheadPumpedStorageForecastCrawler(target_table=TABLE_NAME)
