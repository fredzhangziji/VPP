...
from crawlers.non_market_hydro_output_crawler import (
    NonMarketHydroOutputCrawler,
)

# 目标表名和字段名
TABLE_NAME = 'power_market_data'
FIELD_NAME = 'non_market_hydro_output'

# 设置日志记录器
logger = setup_logger('test_non_market_hydro_output')
...
async def test_single_date():
    ...
    try:
        crawler = NonMarketHydroOutputCrawler(target_table=TABLE_NAME)
