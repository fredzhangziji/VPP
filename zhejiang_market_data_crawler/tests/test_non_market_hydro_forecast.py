...
FIELD_NAME = 'non_market_hydro_forecast'

# 设置日志记录器
logger = setup_logger('test_non_market_hydro_forecast')
...
async def test_single_date():
    ...
    try:
        crawler = NonMarketHydroForecastCrawler(target_table=TABLE_NAME)
