...
from crawlers.day_ahead_wind_total_forecast_crawler import (
    DayAheadWindTotalForecastCrawler,
)

# 目标表名和字段名
TABLE_NAME = 'power_market_data'
FIELD_NAME = 'day_ahead_wind_total_forecast'

# 设置日志记录器
logger = setup_logger('test_day_ahead_wind_total_forecast')
...
async def test_single_date():
    ...
    try:
        crawler = DayAheadWindTotalForecastCrawler(target_table=TABLE_NAME)
