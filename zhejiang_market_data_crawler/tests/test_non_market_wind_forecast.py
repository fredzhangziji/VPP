...
from crawlers.non_market_wind_forecast_crawler import (
    NonMarketWindForecastCrawler,
)

# 目标表名和字段名
TABLE_NAME = 'power_market_data'
FIELD_NAME = 'non_market_wind_forecast'

# 设置日志记录器
logger = setup_logger('test_non_market_wind_forecast')
...
async def test_single_date():
    ...
    try:
        crawler = NonMarketWindForecastCrawler(target_table=TABLE_NAME)
